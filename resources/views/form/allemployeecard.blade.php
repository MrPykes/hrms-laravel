...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <!-- Search Filter -->
            <form action="{{ route('all/employee/card') }}" method="POST">
            <!-- <form action="{{ route('all/employee/search') }}" method="POST"></form> -->
                @csrf
                ...
                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                    <div class="profile-widget">
                        <div class="profile-img">
                            <a href="{{ url('employee/profile/'.$employee->id) }}" class="avatar"><img src="{{ URL::to('/assets/images/photo_defaults.jpg') }}" alt="{{ $employee->name }}"></a>
                        </div>
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="profile.html">{{ $employee->name }}</a></h4>
                        <div class="small text-muted">{{ $employee->position->name }}</div>
                    </div>
                </div>
                @endforeach
            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select select2s-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" id="name" name="name">
                                            ...
                                            @foreach ($employees as $key=>$employee )
                                                <option value="{{ $employee->name }}" data-employee_id={{ $employee->id }} data-email={{ $employee->email }}>{{ $employee->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
