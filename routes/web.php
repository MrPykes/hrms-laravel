...
Route::post('all/employee/card', [App\Http\Controllers\EmployeeController::class, 'cardAllEmployee'])->middleware('auth')->name('all/employee/card');
...
Route::post('all/employee/list', [App\Http\Controllers\EmployeeController::class, 'listAllEmployee'])->middleware('auth')->name('all/employee/list');
...
// Route::post('all/employee/save', function() {
//     echo "<pre>Hello from temporary save route</pre>";
// })->middleware('auth')->name('all/employee/save');
